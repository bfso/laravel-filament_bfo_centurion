...
use App\Filament\Resources\Tables\Filters\CostCentreFilter;
use App\Filament\Resources\Tables\Filters\SubDepartmentFilter;
use App\Filament\Resources\Tables\Filters\TermFilter;
use App\Models\User;
use Filament\Forms;
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('tokenable_id')->getStateUsing(
                    function($record){
                        return User::find($record['tokenable_id'])->pluck('name');
                    }
                )->label('user'),
